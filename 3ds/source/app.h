...
typedef struct {
    ...
    u32 csum_flag;         /* Galaxy: enable flag; write 0x06BA to disarm (0 = none) */
    u32 csum_a, csum_b;    /* the two checksum u16 copies to zero when disarming */
